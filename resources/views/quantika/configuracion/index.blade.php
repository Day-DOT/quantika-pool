        ...
        <div class="setting-card">
            ...
            <form method="POST" action="{{ route('configuracion.update') }}" style="margin-top:18px;">
                ...
                @foreach ($categoriasEdad as $clave => $etiqueta)
                    ...
                    <input class="form-input" name="categoria_{{ match($clave) { 'Bebés' => 'bebes', 'Niños' => 'ninos', 'Adultos' => 'adultos', 'No adultos' => 'no_adultos', 'Mujeres' => 'mujeres', default => 'ninos' } }}" value="{{ $etiqueta }}" required>
                @endforeach
