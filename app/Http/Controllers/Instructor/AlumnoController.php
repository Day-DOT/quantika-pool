...
class AlumnoController extends Controller
{
    ...
    /**
     * Puntaje mínimo de la evaluación del nivel actual para poder
     * promover al alumno al siguiente nivel.
     */
    private const UMBRAL_PROMOCION = 80.0;
     ...
     * Solo se permite si ya tiene una evaluación del nivel actual con al
     * menos el 80% de los criterios logrados.
     */
    public function promover(Request $request, Alumno $alumno): RedirectResponse
    {
        ...
        if (! $evaluacionNivelActual || $evaluacionNivelActual->porcentajeAvance() < self::UMBRAL_PROMOCION) {
            return back()->withErrors([
                'nivel' => 'El alumno debe obtener al menos el '.self::UMBRAL_PROMOCION.'% en la evaluación del nivel actual antes de promoverlo.',
            ]);
        }
